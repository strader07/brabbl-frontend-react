...
const SocialButtons = React.createClass({
  ...
  render() {
    return (<div className="social-login">
      <div>
        <a onClick={ this.loginOnFacebook } className="facebook full-width">
          <img
        ...
        <a onClick={ this.loginOnTwitter } className="facebook full-width">
          <img
        ...
        <a onClick={ this.loginOnGoogle } className="facebook full-width">
          <img
